" ------------------------------------------------------------------------------
" Name:         monk2
" Description:  inspired by monokai theme
" Author:       Logan Richey
" ------------------------------------------------------------------------------
...
let s:bg_sec    = "#3e3d32"
let s:fg        = "#c0c3bb"
let s:comment   = "#5a5b50"
let s:color1    = "#715aab" " scalars
let s:color2    = "#b02752" " operators
let s:color3    = "#52a9b9" " keywords
let s:color4    = "#81b02a" " classes, namespaces, special fname
let s:color5    = "#0000ff" " vi gui text
