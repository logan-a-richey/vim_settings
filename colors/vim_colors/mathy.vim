...
execute 'hi Visual guifg=' . s:bg . ' guibg=' . s:gray
execute 'hi Search guifg=' . s:bg . ' guibg=' . s:gray
execute 'hi IncSearch guifg=' . s:bg . ' guibg=' . s:gray
...
execute 'hi MatchParen guifg=' . s:pink . ' guibg=' . s:bg
